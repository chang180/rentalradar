        ...
        return (
            <div className="rounded-lg border border-dashed border-gray-200 p-6 text-center dark:border-gray-700">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    No investment hotspots detected for the selected filters. Try widening the time range.
                </p>
            </div>
        );
    }
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                        {data.map((hotspot) => (
                            <tr key={hotspot.district} className="hover:bg-gray-50/80 dark:hover:bg-gray-800/60">
                                ...
                                <td className="whitespace-nowrap px-4 py-3 text-sm capitalize text-gray-700 dark:text-gray-200">
                                ...
                                <td className="whitespace-nowrap px-4 py-3 text-sm text-gray-700 dark:text-gray-200">
                                    {hotspot.price_per_ping ? `$${hotspot.price_per_ping.toLocaleString()}` : 'N/A'}
                                </td>
                                <td className="whitespace-nowrap px-4 py-3 text-sm text-gray-700 dark:text-gray-200">
                                    {hotspot.listings}
                                </td>
