...
const MonitoringDashboard: React.FC = () => {
  ...
  const [repairStats, setRepairStats] = useState<RepairStatistics | null>(null);
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className={`text-lg font-medium ${getHealthStatusColor(systemHealth.status)}`}>
                  {systemHealth.status === 'excellent' ? '優秀' :
                   systemHealth.status === 'good' ? '良好' :
                   systemHealth.status === 'fair' ? '一般' :
                   systemHealth.status === 'poor' ? '較差' :
                   systemHealth.status === 'critical' ? '嚴重' : '未知'}
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>CPU 使用率</span>
                  <span className={getMetricColor(systemHealth.core_metrics.cpu_usage, 80)}>
                    {systemHealth.core_metrics.cpu_usage}%
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>記憶體使用率</span>
                  <span className={getMetricColor(systemHealth.core_metrics.memory_usage, 85)}>
                    {systemHealth.core_metrics.memory_usage}%
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>磁碟使用率</span>
                  <span className={getMetricColor(systemHealth.core_metrics.disk_usage, 90)}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>響應時間</span>
                  <span className={getMetricColor(systemHealth.core_metrics.response_time, 1000)}>
                    {formatTime(systemHealth.core_metrics.response_time)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>錯誤率</span>
                  <span className={getMetricColor(systemHealth.app_metrics.error_rate, 5)}>
                    {systemHealth.app_metrics.error_rate}%
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>快取命中率</span>
                  <span className={getMetricColor(100 - systemHealth.app_metrics.cache_hit_rate, 20)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <CardContent>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                  <div 
                    ...
                    style={{ width: `${systemHealth?.core_metrics.cpu_usage}%` }}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                  <div 
                    ...
                    style={{ width: `${systemHealth?.core_metrics.memory_usage}%` }}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                  <div 
                    ...
                    style={{ width: `${systemHealth?.core_metrics.disk_usage}%` }}
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mt-1">活躍連線數</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mt-1">待處理任務</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatTime(systemHealth?.core_metrics.response_time || 0)}
                </div>
                <p className="text-xs text-gray-600 mt-1">平均響應時間</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mt-1">過去 30 分鐘</p>
              </CardContent>
            </Card>

            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium">API 請求</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {systemHealth?.app_metrics.api_requests}
                </div>
                <p className="text-xs text-gray-600 mt-1">總請求數</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mt-1">錯誤百分比</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600 mt-1">快取效率</p>
              </CardContent>
            </Card>

            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium">資料庫查詢</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {systemHealth?.app_metrics.database_queries}
                </div>
                <p className="text-xs text-gray-600 mt-1">查詢次數</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
          ...
          {performance && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold mb-2">
                    {performance.optimization_opportunities.length}
                  </div>
                  <p className="text-sm text-gray-600">
                    可優化項目
                  </p>
          ...
          {repairStats && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {formatTime(repairStats.average_repair_time)}
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="text-sm">
                    {repairStats.last_repair ? 
                      new Date(repairStats.last_repair).toLocaleString() : 
                      '無'
                    }
                  </div>
                </CardContent>
